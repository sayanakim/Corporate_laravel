...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        {{--директива(счетчик итерации) AppServiceProvider->boot--}}
        @set($i, 1)

        @foreach($sliders as $slider)
            <li>
                <div class="slide-holder" style="background:
                    url('{{ asset(env('THEME')) }}/images/{{ $slider->img }}')
...
<div class="mobile-slider">
    <div class="slider fixed-image inner"><img src="{{ asset(env('THEME')) }}/images/cycle-fixed.jpg" alt="" /></div>
</div>
